        ...
        if (typeOfQuestion == Constants.FREETEXT) {
            switch (numeral2Base) {
                case 2:
                    ...
                    break;
                case 3:
                    myKeyboard = new Keyboard(this, R.xml.keyboard3);
                    break;
                case 4:
                    myKeyboard = new Keyboard(this, R.xml.keyboard4);
                    break;
                case 5:
                    myKeyboard = new Keyboard(this, R.xml.keyboard5);
                    break;
                case 6:
                    myKeyboard = new Keyboard(this, R.xml.keyboard6);
                    break;
                case 7:
                    myKeyboard = new Keyboard(this, R.xml.keyboard7);
                    break;
                case 8:
                    myKeyboard = new Keyboard(this, R.xml.keyboard8);
                    break;
                case 9:
                    myKeyboard = new Keyboard(this, R.xml.keyboard9);
                    break;
                case 10:
                    myKeyboard = new Keyboard(this, R.xml.keyboard10);
                    break;
                case 11:
                    myKeyboard = new Keyboard(this, R.xml.keyboard11);
                    break;
                case 12:
                    myKeyboard = new Keyboard(this, R.xml.keyboard12);
                    break;
                case 13:
                    myKeyboard = new Keyboard(this, R.xml.keyboard13);
                    break;
                case 14:
                    myKeyboard = new Keyboard(this, R.xml.keyboard14);
                    break;
                case 15:
                    myKeyboard = new Keyboard(this, R.xml.keyboard15);
                    break;
                case 16:
                    myKeyboard = new Keyboard(this, R.xml.keyboard16);
                    break;
                default:
                    myKeyboard = new Keyboard(this, R.xml.keyboard16);
            }
