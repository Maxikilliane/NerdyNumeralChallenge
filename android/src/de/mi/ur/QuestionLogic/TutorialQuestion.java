...
public class TutorialQuestion {
    ...
    //Jedes Array entspricht einem Tutorial, die Questions sind in der richtigen Reihenfolge abgespeichert.
    ...
    //unnecessary code (just here for safety)
     /*
     ...
     private FreeTextQuestion question3 = new FreeTextQuestion(10, 2, 2);
     private FreeTextQuestion question4 = new FreeTextQuestion(10, 2, 2);
     private FreeTextQuestion question5 = new FreeTextQuestion(10, 4, 2);
...
Aus dem Konstruktor:
    ...
    //this.questionType = questionTypes [tutorialTypeConstant][questionNumber];
    */
}
